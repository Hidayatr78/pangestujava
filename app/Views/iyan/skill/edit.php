<div class="card-body">
    ...
    ?>
    <form action="<?php echo base_url('iyan/skill/edit/' . $keahlian['deskripsi_keahlian']); ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <div class="input-group">
                <div class="custom-file">
                    <input type="file" multiple name="gambar_keahlian[]" id="gambar" name="gambar_keahlian" value="<?php echo base_url('/upload/image/skill/' . $keahlian['gambar_keahlian']) ?>"></input>
        ...
        <div class=" form-group">
                    ...
                    <div class="input-group">
                        <img src="<?php echo base_url('/upload/image/skill/' . $keahlian['gambar_keahlian']) ?>" class="img img-responsive img-thumbnail " width="150">
                    </div>
                </div>
